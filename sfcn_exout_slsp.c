 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Sun May 26 00:29:47 2013
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfcn_exout_slsp
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sfcn_exout_slsp_Outputs_wrapper(const boolean_T *in,
                           
			      const real_T  *xD,
                          const uint8_T  *pin, const int_T p_width0);
extern void sfcn_exout_slsp_Update_wrapper(const boolean_T *in,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sfcn_exout_slsp_Outputs_wrapper(in, xD, pin, p_width0);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sfcn_exout_slsp_Update_wrapper(in,  xD, pin, p_width0);
}
