...
#define S_FUNCTION_NAME sf_QuadEncoder_PCINT
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sf_QuadEncoder_PCINT_Outputs_wrapper(int16_T *pos ,
			      const real_T  *xD,
                          const uint8_T  *enc, const int_T  p_width0, 
                          const uint8_T  *pinA, const int_T  p_width1, 
                          const uint8_T  *pinB, const int_T p_width2);
extern void sf_QuadEncoder_PCINT_Update_wrapper(const int16_T *pos ,
                          real_T *xD, 
                          const uint8_T  *enc,  const int_T  p_width0,
                          const uint8_T  *pinA,  const int_T  p_width1,
                           const uint8_T *pinB, const int_T  p_width2);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sf_QuadEncoder_PCINT_Outputs_wrapper(pos, xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sf_QuadEncoder_PCINT_Update_wrapper(pos,  xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
}
