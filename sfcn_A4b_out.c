 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Thu Aug  8 21:01:46 2013
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfcn_A4b_out
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sfcn_A4b_out_Outputs_wrapper(const boolean_T *in,
                           
			      const real_T  *xD,
                          const boolean_T  *pin, const int_T p_width0);
extern void sfcn_A4b_out_Update_wrapper(const boolean_T *in,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const boolean_T  *pin  = (const boolean_T *)mxGetData(PARAM_DEF0(S));

    sfcn_A4b_out_Outputs_wrapper(in, xD, pin, p_width0);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sfcn_A4b_out_Update_wrapper(in,  xD, pin, p_width0);
}
