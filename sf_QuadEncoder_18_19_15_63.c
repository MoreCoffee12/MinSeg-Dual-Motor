/*
 * File: sf_QuadEncoder_18_19_15_63.c
 *
 *
  *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Sun Jun 30 17:40:41 2013
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sf_QuadEncoder_18_19_15_63
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sf_QuadEncoder_18_19_15_63_Outputs_wrapper(int16_T *pos1,
                          int16_T *pos2 ,
			      const real_T  *xD,
                          const uint8_T  *enc, const int_T  p_width0, 
                          const uint8_T  *pinA, const int_T  p_width1, 
                          const uint8_T  *pinB, const int_T p_width2);
extern void sf_QuadEncoder_18_19_15_63_Update_wrapper(const int16_T *pos1,
                          const int16_T *pos2 ,
                          real_T *xD, 
                          const uint8_T  *enc,  const int_T  p_width0,
                          const uint8_T  *pinA,  const int_T  p_width1,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sf_QuadEncoder_18_19_15_63_Outputs_wrapper(pos1, pos2, xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sf_QuadEncoder_18_19_15_63_Update_wrapper(pos1, pos2,  xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
}
