/*
 * File: sf_MPU6050_2xDriver_GxAyz.c
 *
  *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sun Mar  8 10:13:46 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sf_MPU6050_2xDriver_GxAyz
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  3 */
#define OUT_PORT_3_NAME      x_vel_2
...
/* Output Port  4 */
#define OUT_PORT_4_NAME      y_acc_2
...
/* Output Port  5 */
#define OUT_PORT_5_NAME      z_acc_2
...
extern void sf_MPU6050_2xDriver_GxAyz_Outputs_wrapper(int16_T *x_vel,
			int16_T *y_acc,
			int16_T *z_acc,
			int16_T *x_vel_2,
			int16_T *y_acc_2,
			int16_T *z_acc_2,
			const real_T *xD);
extern void sf_MPU6050_2xDriver_GxAyz_Update_wrapper(const int16_T *x_vel,
			const int16_T *y_acc,
			const int16_T *z_acc,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    int16_T        *x_vel_2  = (int16_T *)ssGetOutputPortRealSignal(S,3);
    int16_T        *y_acc_2  = (int16_T *)ssGetOutputPortRealSignal(S,4);
    int16_T        *z_acc_2  = (int16_T *)ssGetOutputPortRealSignal(S,5);
    const real_T   *xD = ssGetDiscStates(S);


    sf_MPU6050_2xDriver_GxAyz_Outputs_wrapper(x_vel, y_acc, z_acc, x_vel_2, y_acc_2, z_acc_2, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sf_MPU6050_2xDriver_GxAyz_Update_wrapper(x_vel, y_acc, z_acc, x_vel_2, y_acc_2, z_acc_2,  xD);
}
