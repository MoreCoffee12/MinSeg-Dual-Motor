 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Sun Jul 20 06:02:02 2014
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sf_Test
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sf_Test_Outputs_wrapper(const boolean_T *in,
                           
			      const real_T  *xD,
                          const uint8_T  *pin, const int_T p_width0);
extern void sf_Test_Update_wrapper(const boolean_T *in,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sf_Test_Outputs_wrapper(in, xD, pin, p_width0);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sf_Test_Update_wrapper(in,  xD, pin, p_width0);
}
