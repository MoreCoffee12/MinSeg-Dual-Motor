 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Tue Jun 11 15:59:21 2013
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sf_MPU6050_Driver
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void sf_MPU6050_Driver_Outputs_wrapper(int16_T *x_vel,
                          int16_T *y_vel,
                          int16_T *z_vel,
                          int16_T *x_acc,
                          int16_T *y_acc,
                          int16_T *z_acc,
                          const real_T  *xD);
extern void sf_MPU6050_Driver_Update_wrapper(const int16_T *x_vel,
                          const int16_T *y_vel,
                          const int16_T *z_vel,
                          const int16_T *x_acc,
                          const int16_T *y_acc,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    int16_T        *y_vel  = (int16_T *)ssGetOutputPortRealSignal(S,1);
    int16_T        *z_vel  = (int16_T *)ssGetOutputPortRealSignal(S,2);
    int16_T        *x_acc  = (int16_T *)ssGetOutputPortRealSignal(S,3);
    int16_T        *y_acc  = (int16_T *)ssGetOutputPortRealSignal(S,4);
    int16_T        *z_acc  = (int16_T *)ssGetOutputPortRealSignal(S,5);
    const real_T   *xD = ssGetDiscStates(S);

    sf_MPU6050_Driver_Outputs_wrapper(x_vel, y_vel, z_vel, x_acc, y_acc, z_acc, xD);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sf_MPU6050_Driver_Update_wrapper(x_vel, y_vel, z_vel, x_acc, y_acc, z_acc,  xD);
}
